...
def getBestMatchIndex(input_avg, avgs):
    ...
    if min_dist < 200:
        ...
        print(type(thisdict["match_index"]))
        print(type(thisdict["status"]))
...
def createPhotomosaic(target_image, input_images, grid_size,
    ...
    for img in target_images:
        ...
        if len(input_images) > 0:
            match_indexdis = getBestMatchIndex(avg, avgs)
            match_index = match_indexdis["match_index"]
            match_status = match_indexdis["status"]
            print(match_status)
            ...
            if match_status == False:
                ...
                output_images[index_counter] = input_images[match_index]
        ...
        if not reuse_images and len(input_images) > 0:
...
def main():
    ...
    # output
    output_filename = './static/img/mosaic.png'
    if args.outfile:
